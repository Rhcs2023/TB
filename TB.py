...
st.title("Traductor de Español a Mixteco, versión Chalcatongo Oaxaca.")
...
oracion_usuario = st.text_area("Introduce una oración, los pronombres posesivos van despues del sujeto; Ejemplo: Padre mi va al centro.", height=100)
